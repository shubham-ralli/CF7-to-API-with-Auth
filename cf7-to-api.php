...
?>
    ...
    <p><label for="cf7-api-url"><?php _e('API URL:', 'cf7-api'); ?></label>
        <input type="text" id="cf7-api-url" name="cf7_api_url" value="<?php echo esc_attr($api_url); ?>" size="80" />
    </p>
    <p><label for="cf7-auth-type"><?php _e('Auth Type:', 'cf7-api'); ?></label>
    ...
    <p><label for="cf7-auth-key"><?php _e('Auth Key/Token:', 'cf7-api'); ?></label>
        <input type="text" id="cf7-auth-key" name="cf7_auth_key" value="<?php echo esc_attr($auth_key); ?>" size="80" />
    </p>
    <p><label for="cf7-method"><?php _e('HTTP Method:', 'cf7-api'); ?></label>
    ...
    <p><label for="cf7-json-template"><?php _e('JSON Template:', 'cf7-api'); ?></label>
